...
export class AlbumnService {
  ...
  public currentAlbumList : AlbumnRequest[] = [];
  public currentAlbumThirtPo : AlbumnRequest = new AlbumnRequest() ;
  public currentAlbumFourthPo : AlbumnRequest = new AlbumnRequest() ;
  ...
  createListOfAlbum(albumlist: AlbumnRequest): Observable<ImageHandler[]> {
    const url = this.prefixUrl + API_URL.CREATE_ALBUMS;
